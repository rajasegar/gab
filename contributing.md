# Contributing to github-actions-builder

First and foremost, thank you! We appreciate that you want to contribute to github-actions-builder, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for github-actions-builder**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for github-actions-builder:

- star the [project](https://github.com/rajasegar/github-actions-builder)
- tweet your support for github-actions-builder
...
- **version**: (required) please note the version of github-actions-builder are you using
...
The original poster or the maintainers of github-actions-builder may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/github-actions-builder
